...
use Rector\Naming\Rector\ClassMethod\RenameParamToMatchTypeRector;
    ...
    // uncomment to reach your current PHP version
        ...
        ->withIndent()
        ->withImportNames(removeUnusedImports: true)->withFluentCallNewLine()
    ...
    // Soms wil je bepaalde naamgeving in Laravel behouden (zoals underscores in migrations)
                   ->withSkip([
                       RenameParamToMatchTypeRector::class => [
                           __DIR__ . '/src/Filament/Admin/Resources/SponsorResource.php',
                           __DIR__ . '/src/Filament/Admin/Resources/Sponsors/Schemas/SponsorTable.php',
                       ],
